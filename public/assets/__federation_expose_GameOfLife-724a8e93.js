...
import { r as reactExports } from './index-10f2299d.js';
...
const SingleCell = ({ cell, index, size }) => {
  ...
  return /* @__PURE__ */ jsx("div", { style: styleOuter, children: /* @__PURE__ */ jsx("div", { style: styleInner }) }, `${x}_${y}`);
};
...
function GameOfLife() {
  ...
  useEffect(() => {
    ...
    containerRef.current?.addEventListener("resize", resizeWindow);
  }, []);
