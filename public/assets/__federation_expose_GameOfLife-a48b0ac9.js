...
function GameOfLife() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { width: "100%" }, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mb-2", children: [
      /* @__PURE__ */ jsx("button", { className: "btn btn-xs", onClick: handleRestart, children: "Restart" }),
      /* @__PURE__ */ jsx("button", { className: "btn btn-xs", onClick: toogleStepper, children: pauseRef.current ? "continue" : "Pause" }),
