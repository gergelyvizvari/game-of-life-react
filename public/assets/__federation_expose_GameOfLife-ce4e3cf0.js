...
function GameOfLife() {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { width: "100%" }, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mt-2", children: [
      /* @__PURE__ */ jsx("button", { className: "btn bt-sm", onClick: handleRestart, children: "Restart" }),
      /* @__PURE__ */ jsx("button", { className: "btn bt-sm", onClick: toogleStepper, children: pauseRef.current ? "continue" : "Pause" }),
